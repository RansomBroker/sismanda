<div>
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Inventaris / List Barang Masuk /</span>  Tambah Barang Masuk Baru</h4>
        ...
        <div class="card-body">
            <form wire:submit="add">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="file" id="image" class="form-control" name="image" wire:model="image" required>
                </div>
